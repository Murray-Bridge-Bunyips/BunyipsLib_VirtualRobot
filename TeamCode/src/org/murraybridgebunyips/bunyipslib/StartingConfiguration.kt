...
import org.murraybridgebunyips.bunyipslib.StartingConfiguration.Origin.RIGHT
...
//            )
    ...
    class Builder(private val alliance: Alliance, private val origin: Origin) {
         ...
         * The build method is automatically called if forgotten via [AutonomousBunyipsOpMode] `setOpModes()`, ensure
