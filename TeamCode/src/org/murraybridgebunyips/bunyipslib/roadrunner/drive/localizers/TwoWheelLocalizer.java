...
public class TwoWheelLocalizer extends TwoTrackingWheelLocalizer {
     ...
     */
    public TwoWheelLocalizer(Coefficients coefficients, Deadwheel parallelDeadwheel, Deadwheel perpendicularDeadwheel, Moveable drive) {
     ...
     */
    public TwoWheelLocalizer(Coefficients coefficients, Deadwheel parallelDeadwheel, Deadwheel perpendicularDeadwheel, Localizer headingLocalizer) {
        super(Arrays.asList(
