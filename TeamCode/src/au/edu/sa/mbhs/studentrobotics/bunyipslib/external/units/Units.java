...
public final class Units {
    ...
    public static final Distance FieldTiles = derive(Inches).aggregate(24).named("Field Tile").symbol("FT").make();
    ...
    public static final Time Second = Seconds; // Singularised alias
